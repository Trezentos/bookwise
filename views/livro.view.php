<?php
    ...
    $sumNotas = array_reduce($avaliacoes, function($carry, $item) {
        return  ($carry ?? 0) + $item->nota;
    } ?? 0);
    ...
    <div>
        <?php if(auth()): ?>
            <div class="border border-stone-700 rounded ">
                <h1 class="border-b border-stone-700 text-stone-400 font-bold px-4 py-2">Conte para gente o que você achou</h1>
                <form action="/avaliacao-criar" method="post" class="p-4 space-y-4">
                    ...
                    <div class="flex flex-col">
                        ...
                        <label for="" class="text-stone-500 mb-1">Avaliação</label>
                        <textarea
                                type="text"
                                rows="6"
                                name="avaliacao"
